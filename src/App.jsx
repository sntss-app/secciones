...
function App() {
    ...
    return (
        <BrowserRouter>
            ...
            {/* ✨ FORMAS Y ONDAS DECORATIVAS DE FONDO (SECCIÓN 5) */}
            <div className="app-bg-decorations">
                <svg className="bg-wave-top-right" viewBox="0 0 500 500" fill="currentColor">
                    <path d="M150,0 C300,150 400,50 500,200 L500,0 Z"></path>
                </svg>
                <div className="bg-dots-top-left dot-matrix"></div>
                <div className="bg-dots-center-left dot-matrix"></div>
                <div className="bg-dots-bottom-right dot-matrix"></div>
                <svg className="bg-wave-bottom-left" viewBox="0 0 500 500" fill="currentColor">
