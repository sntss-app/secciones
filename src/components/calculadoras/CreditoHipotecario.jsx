        ...
        <div style={styles.container}>
            ...
            {resultado && (
                <div style={styles.resultado}>
                    <p className="fw-bold">Monto del crédito según liquidez:</p>
                    <div className="bg-light p-2 rounded border mb-2">
                        <span className="d-block text-primary">Por 75 veces el Salario Mensual Integrado</span>
                        <span style={styles.monto}>{formatter.format(resultado.monto75)}</span>
                    </div>
                    <div className="bg-light p-2 rounded border">
                        <span className="d-block text-success">Por 90 veces el Salario Mensual Integrado</span>
                        <span style={styles.monto}>{formatter.format(resultado.monto90)}</span>
                    </div>
                </div>
            )}
        </div>
